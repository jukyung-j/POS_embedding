    ...
    if input_reprs is None:
      ...
      with tf.variable_scope(
        ...
        self.embedding_output = embedding_postprocessor(
            ...
            use_pos_type=True,
            pos_ids=pos_ids,
            pos_embedding_name="pos_embeddings",
...
def embedding_postprocessor(input_tensor,
  ...
  if use_pos_type:
      ...
      pos_type_embeddings = tf.matmul(one_hot_pos, pos_type_table)
      pos_type_embeddings = tf.reshape(pos_type_embeddings,
                                       [batch_size, seq_length, width])

      output += pos_type_embeddings
